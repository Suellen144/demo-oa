    ...
    createNode: function (data) {
      ...
      if (opts.verticalLevel && level >= opts.verticalLevel) {
        ...
        if (Number(flags.substr(0,1))) {
          $nodeDiv.append('<i class="edge verticalEdge"></i>');
        }
        if(Number(flags.substr(1,1))) {
          $nodeDiv.append('<i class="edge horizontalEdge"></i>' +
            '<i class="edge horizontalEdge"></i>');
        }
        ...
        if (isVerticalLayer) {
          ...
          if (level + 1 === opts.verticalLevel) {
        	...
        	if(data!=null && data.organization !=null){
        		 $upperLines = $('<tr class="lines' + isHidden + '"><td colspan="' + childrenData.length * 2 + '"><div class="downLine"></div><div class="downLine" ><div id="'+data.organization.id+'" data-parent="'+data.organization.parentId+'" class="node nodeK" style="left:15px;top:-7px;width: 230px;"><div class="title1 clan-man" name="generateKpi" id="generateKpi">'+data.organization.name+'</div><i class="edge verticalEdge"></i></div></div><div class="downLine"><div style="background-color:rgba(192, 192, 192, 0.8);margin:0 auto;height:2px;width:20px;float:none;"></div></div><div class="downLine"></div></td></tr>');
        	}else{
        		$upperLines = $('<tr class="lines' + isHidden + '"><td colspan="' + childrenData.length * 2 + '"><div class="downLine"></div></td></tr>');
        	}
