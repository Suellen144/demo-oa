				...
				<div class="box box-primary">
					<div class="box-header">
						<form id="searchForm" class="form-inline" role="form">
							<input type="hidden"  id ="currUserId" value="${sessionScope.user.id }"readonly>
								<td><label for="roleName_duplicate" class="control-label" style="margin-left: 8px">提成截止时间</label></td>
								<td>
									<input class="form-control" id="stopTime" name="startTime" placeholder="截止时间" style="background-color: inherit;margin-left: 8px" readonly>
								</td>
					...
					<div class="box-body">
							<table id="dataTable2" class="table table-bordered table-hover" style="text-align: center;">
								<thead>
									<tr>
										...
										<th style="width: 25%;text-align:center">提成截止时间</th>
							...
							<div style="text-align: center;font-weight: bolder;font-size: 1em;width: 90%;margin: auto;height: 34px;line-height: 34px;position: relative;">
								<span style="position: absolute;left: 0;right: 0;margin: auto;">人员提成分配表</span>
							</div>
...
<script type="text/javascript" src="<%=base%>/views/manage/finance/projectApplication/js/royaltyNew.js"></script>
