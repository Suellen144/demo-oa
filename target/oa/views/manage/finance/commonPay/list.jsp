...
<ul id="myTab" class="nav nav-tabs rlspace">
  		<li class="active"><a href="#list" data-toggle="tab">常规付款管理</a></li>
  		<shiro:hasPermission name="fin:commonReceived:see">
    		<li><a href="#normalReceive" data-toggle="tab">常规收款管理</a></li> 
    	</shiro:hasPermission>
</ul>
...
<div class="wrapper">
					...
					<div class="box-header">
						 <form id="searchForm" class="form-inline" role="form">
							 <table id="searchTable">
								...
								<td><button id="addBtn" type="button" class="btn btn-primary" onclick="add()" style="height: 35px;margin-left:10px;text-align: center;">添加常规付款</button></td>
							</tr>
						</table>
					</form>
	...
	<div class="tab-pane fade" id="normalReceive">
      <iframe id="normalReceive_iframe" name="normalReceive_iframe" width="100%" height="1000"  frameborder="no" scrolling="yes" src="<%=base%>/manage/finance/commonReceived/toList"></iframe>
   </div>
</div>
...
<script type="text/javascript" src="<%=base%>/views/manage/finance/commonPay/js/list.js"></script>
</body>
</html>