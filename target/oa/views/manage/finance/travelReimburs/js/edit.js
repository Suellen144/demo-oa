...
function save() {
	//bootstrapConfirm("提示", "是否确定保存？", 300, function() {
	    ...
	    var checkMsg = checkFormWithoutravel(formData);
...
function checkFormWithoutravel(formData) {
    var checkMsg = {};
    var validFields = $.extend(true, [], validElements);
    var dateComp = null;
...
function getHtmlForStayCost() {
    ...
    html.push(' <td style="width: 5%;"><input type="text" name="cost" style="text-align:right;"  ></td>');
    html.push(' <td style="width: 5%;"><input type="text" name="actReimburse" style="text-align:right;" ></td>');
    html.push(' <td style="width: 15%;"><textarea name="reason"  autocomplete="off" onfocus="reasonChange(this, \'stayCost\')"></textarea></td>');
    html.push(' <td style="width: 30%;"><textarea name="detail"></textarea></td>');
    /*html.push(' <td style="width: 11%;"><input type="text" name="remark"></td>');*/
...
function getHtmlForCityCost() {
    ...
    html.push(' <td style="width: 25%;"><textarea name="detail"></textarea></td>');
...
function getHtmlForReceiveCost() {
    ...
    html.push(' <td style="width: 7%;"><input type="text" name="cost" style="text-align:right;"  ></td>');
    html.push(' <td style="width: 7%;"><input type="text" name="actReimburse" style="text-align:right;" ></td>');
    html.push(' <td style="width: 20%;"><textarea name="reason" autocomplete="off" onfocus="reasonChange(this, \'receiveCost\')"></textarea></td>');
    html.push(' <td style="width: 30%;"><textarea name="detail"></textarea></td>');
...
function getHtmlForSubsidy() {
   ...
   /* if(ishavatrafficSubsidy.length>0){
    ...
    html.push(' <td style="width: 20%;"><textarea name="reason" autocomplete="off" onfocus="reasonChange(this, \'subsidy\')"></textarea></td>');
    html.push(' <td style="width: 30%;"><textarea type="text" name="detail"></textarea></td>');
...
function updateTotal() {
    var total = 0.0;
    var traffic = $("tr[name='node']").find("input[name='trafficSubsidy']").val();
...
//删除报销单
function del() {
    bootstrapConfirm("提示", "是否确认删除报销单？", 300, function () {
        $.ajax({
            url: web_ctx + "/manage/finance/travelReimburs/remove",
            data: {"id": $("#id").val()},
            type: "post",
            dataType: "json",
            success: function (data) {
                if (data.code == 1) {
                    ...
                    bootstrapAlert("错误提示", data.result, 400, null);
                }
            },
            error: function (data) {
                bootstrapAlert("提示", "网络错误，请稍后重试！", 400, null);
