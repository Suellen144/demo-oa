				...
				<div class="box box-primary">
					<div class="box-header">
							...
							<div class="form-group">
								<label for="name" class="col-sm-4 control-label" style="float:left;line-height:2.5em;">出差人员</label>
								<input class="form-control" id="name" name="name" placeholder="出差人员" style="float:left;width:65%;">
							</div>
							<div class="form-group">
							...
							<button type="button" class="btn btn-primary" onclick="toAdd()" style="float:right;">出差报销</button>
							</form>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
...
<script type="text/javascript" src="<%=base%>/views/manage/finance/travelReimburs/js/list.js"></script>
<script>
