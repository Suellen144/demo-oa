					...
					<div class="box-header">
						 <form id="searchForm" class="form-inline" role="form">
							 <table id="searchTable">
								<tr>
									<td><button id="addBtn" type="button" class="btn btn-primary" onclick="toAdd()">外勤登记</button></td>
...
<div class="modal fade" id="legWorkModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-sm-15" style="width:90%">
...
<script type="text/javascript" src="<%=base%>/views/manage/ad/chkatt/legwork/js/list.js"></script>
</body>
</html>