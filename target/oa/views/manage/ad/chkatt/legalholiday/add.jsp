						...
						<table id="table1">
							...
							<tbody>
								<tr>
									...
									<tr name="node">
									<td colspan="1"><input type="text" name="name" size="18" ></td>
									<td colspan="1"><input type="text" name="dateBelongs"  class="dateBelongs"  size="18" readonly ></td>
									<td colspan="1"><input type="text" name="startDate" class="startDate" size="18" readonly></td>
									<td colspan="1"><input type="text" name="endDate"  class="endDate"  size="18" readonly ></td>
									<td colspan="1"><input type="text" name="legal"  class="legal"  size="18" readonly ></td>
									<td colspan="1"><input type="text" name="numberDays" class="input"  value = ""></td>
									<td colspan="1"><input type="text" name="beforeLeave"  class="beforeLeave"  size="18" readonly ></td>
									<td colspan="1"><input type="text" name="afterLeave"  class="afterLeave" size="18" readonly></td>
									<td colspan="2">
...
<script type="text/javascript" src="<%=base%>/views/manage/ad/chkatt/legalholiday/js/add.js"></script>
</body>
</html>