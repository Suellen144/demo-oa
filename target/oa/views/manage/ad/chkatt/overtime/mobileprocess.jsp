								...
								<c:when test="${(map.task.name eq '提交申请' or map.task.name eq '部门经理') and map.business.userId eq sessionScope.user.id }">
									...
									<tbody>
										...
										<tr>
											...
											<td class="mFormMsg">
												自
												<input id="startTime" name="startTime" size="18" class="starttime" style="width:100%;" value="<fmt:formatDate value="${map.business.startTime}" pattern="yyyy-MM-dd HH:mm" />"  readonly>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="mFormMsg">
												共
												<input id="days" name="days" style="width:3em;" value="${map.business.days }" >
										...
										<tr>
											...
											<td class="mFormMsg" ><textarea name="reason" rows="7" cols="70">${map.business.reason }</textarea></td>
										</tr>
									</tbody>
								</c:when>
								...
								<c:otherwise>
									...
									<tbody>
										...
										<tr>
											...
											<td class="mFormMsg">
												自
												<input id="startTime" name="startTime" size="18" value="<fmt:formatDate value="${map.business.startTime}" pattern="yyyy-MM-dd HH:mm" />"   class="starttime" style="width:100%; border: none;" readonly>
											</td>
										</tr>
										<tr>
											<td class="mFormName"><span></span></td>
										...
										<tr>
											...
											<td class="mFormMsg">
												至
												<input id="endTime" name="endTime" size="18" class="endtime" style="width:100%;border: none;" readonly value="<fmt:formatDate value="${map.business.endTime}" pattern="yyyy-MM-dd HH:mm" />" readonly>
											</td>
										</tr>
										<tr>
											<td class="mFormName"><span></span></td>
											<td class="mFormMsg">
												共
												<input id="days" name="days" style="width:3em;border: none;" readonly value="${map.business.days }" >
												<label id="label_days">天</label>
												<input id="hours" name="hours" style="width:3em;border: none;" readonly value="<fmt:formatNumber value='${map.business.hours }' pattern='#.#' />" >
												<label id="label_hours">小时</label>
											</td>
										</tr>
										<tr>
