						...
						<table id="table1">
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="3"><input type="text" name="applyTime" value="<fmt:formatDate value="${currDate}" pattern="yyyy-MM-dd" />" readonly></td>
								</tr>
								<tr>
									<td><span>加班起止时间</span></td>
									<td colspan="20" style="padding-right:30px;">
										自
										<input id="startTime" name="startTime" size="18" class="starttime" style="width:15%;" readonly onchange="checkDate()">
										至
									    <input id="endTime" name="endTime" size="18" class="endtime" style="width:15%;" readonly onchange="checkDate()">
									           共
