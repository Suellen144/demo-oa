						...
						<c:choose>
							...
							<tbody>
								...
								<tr>
									...
									<td style="width: 8%"><span>所属单位</span></td>
...
<script type="text/javascript" src="<%=base%>/views/manage/sale/barginManage/js/processMarketAgreement.js"></script>
