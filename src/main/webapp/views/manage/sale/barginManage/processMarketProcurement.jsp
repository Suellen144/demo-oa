					...
					<form id="form1" >
						...
						<c:choose>
							...
							<tbody>
								...
								<tr>
									...
									<td   style="width: 12%"><span>合同期限</span></td>
									<td colspan="7">
								...
								<tr>
									...
									<td colspan="2" style="width:15%"><input type="text" id ="name" value="${map.business.sysUser.name }"readonly></td>
									<td style="width: 8%"><span>发起时间</span></td>
									<td colspan="7" style="width:15%"><input type="text" name="applyTime" id ="applyTime" value='<fmt:formatDate value="${map.business.createDate }" pattern="yyyy-MM-dd" />' readonly></td>
									
									<td><span>所属单位</span></td>
									<td colspan="8" style="width:20%;line-height:inherit;text-align:left;">
						...
						<c:otherwise>
								...
								<tr>
									...
									<td   colspan="1"><span>合同总金额</span></td>
								...
								<tr>
									<td  style="width: 8%"><span>发起人</span></td>
									<td colspan="2" style="width:15%"><input type="text"  id ="name" value="${map.business.sysUser.name }" style="text-align: center;" readonly></td>
									<td style="width: 8%"><span>发起时间</span></td>
									<td  colspan="7" style="width:15%"><input type="text" name="applyTime"  id ="applyTime" style="text-align: center;" value='<fmt:formatDate value="${map.business.createDate }" pattern="yyyy-MM-dd" />' readonly></td>
									<td><span>所属单位</span></td>
			...
			<div class="col-md-12">
				<div class="box box-primary tbspace">
					<div style="text-align: center;font-weight: bolder;font-size: 1em;width: 90%;margin: auto;height: 34px;line-height: 34px;position: relative;">
							<span style="position: absolute;left: 0;right: 0;margin: auto;">付款记录</span>
							<c:if test="${map.business.projectManage.status ne '-1' and map.business.projectManage.status ne '0'}">
								<div style="float: right;position: absolute;margin: auto;right: 0px;top: 6px;">
									<button type="button" class="btn btn-primary" style="float: right;position: absolute;margin: auto;right: 0;" onclick="toPayAdd()">付款申请</button>
								</div>
							</c:if>
						</div>
					...
					<div style="text-align: center;font-weight: bolder;font-size: 1em;width: 90%;margin: auto;height: 34px;line-height: 34px;position: relative;">
							...
							<c:if test="${sessionScope.user.dept.id eq '4' or sessionScope.user.dept.id eq '2'}">
								<c:if test="${map.business.projectManage.status ne '-1' and map.business.projectManage.status ne '0'}">
									<div style="float: right;position: absolute;margin: auto;right: 0px;top: 6px;">
										<button type="button" class="btn btn-primary" style="float: right;position: absolute;margin: auto;right: 0;" onclick="toAddOrEdit()">添加收票记录</button>
									</div>
								</c:if>
							</c:if>
						</div>
...
<script type="text/javascript" src="<%=base%>/views/manage/sale/barginManage/js/processMarketProcurement.js"></script>
