						...
						<table id="table1">
							...
							<tbody>
								...
								<tr>
									...
									<td><span>目的地</span></td>
									<td>
										<input name="desitination" type="text" value="">
									</td>
								</tr>
								<tr>
									...
									<td colspan="20" style="padding-right:30px;">
										自
										<input id="startTime" name="startTime" size="18" class="starttime" style="width:26%;" readonly>
										至
									    <input id="endTime" name="endTime" size="18" class="endtime" style="width:26%;" readonly>
									</td>
								</tr>
								<tr>
...
<script type="text/javascript" src="<%=base%>/views/manage/ad/car/js/add.js"></script>
</body>
</html>