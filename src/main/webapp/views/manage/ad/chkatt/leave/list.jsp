					...
					<div class="box-header">
					 	<form id="searchForm" class="form-inline" role="form">
							 <table id="searchTable">
								<tr>
									<td><button id="addBtn" type="button" class="btn btn-primary" onclick="toAdd()">申请请假</button></td>
									...
									<td><label for="" class="control-label">请假时间</label></td>
									<td>
...
<script type="text/javascript" src="<%=base%>/views/manage/ad/chkatt/leave/js/list.js"></script>
</body>
</html>