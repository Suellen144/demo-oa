...
<div class="wrapper">
	...
	<section class="content rlspace">
			<section class="col-md-10 connectedSortable ui-sortable" style="width:100%;height:100%;padding-left:0">
				<div class="box box-primary box-solid">
					<div class="box-body"> 
						<form id="form1">
							<table>
								<thead>
									<tr><input type="text" name="title" value="" placeholder="请输入计划标题" style="width:100%;height:100%;font-weight：bolder;font-size:24px;border:none;text-align:center;"></tr>
								...
								<c:forEach items="${list}" var="reward" varStatus="itemIndex">
									...
									<c:forEach items="${reward}" var="a" varStatus="itemIndex2">						
										<tr name = "node" data-i = "${itemIndex.index}" > 					
											...
											<td style="width:8%;"><input  type="text" name="salary" value = "${a.salary.salary}" readonly></td>
											<td style="width:6%;"><input  type="text" name="score"  value="<fmt:formatNumber value='${a.record.score}' pattern='#.#' />" readonly></td>
											<td style="width:6%;"><input  name="coefficient" type="text"  value = "0"></td>
											<td style="width:6%;"><input style="text-align: right;" name = "money" type="text" value = "0" readonly></td>
											<td style="width:6%;"><input style="text-align: right;" name="otherreward" type="text" value = "0"></td>
											<td style="width:6%;"><input style="text-align: right;background:#fff" name="totalbonus" disabled="disabled" type="text"  value = "0"></td>
...
<script type="text/javascript" src="<%=base%>/views/manage/ad/reward/js/add.js"></script>
</body>
</html>
	...
	var boot = false;
 	$(function(){
 		$(".box-body #form1").find("input[name='coefficient']").bind("input",function(event){
 			...
 			console.log(boot,boot != true)
 			if(boot != true){
 				alert('请在解密后在执行此操作');
 				tr.find("input[name='coefficient']").val(0);
 				return;
 			}
			try {
 		...
 		$(".box-body #form1").find("input[name='otherreward']").bind("input",function(event){
	 	    ...
	 	    if(boot != true){
				alert('请在解密后在执行此操作');
				tr.find("input[name='otherreward']").val(0);
				return;
			}
