...
<div class="wrapper">
	...
	<section class="content rlspace">
		<div class="row">
			<div class="col-md-12">
				<shiro:hasPermission name="ad:rulesReg:public">
					<button type="button" class="btn btn-primary" onclick="setMode('edit')">编辑模式</button>
					<button type="button" class="btn btn-primary" onclick="setMode('view')">普通模式</button>
				</shiro:hasPermission>
				<shiro:hasPermission name="ad:rulesReg:approve">
					<c:if test="${hasUnpublic }">
						<button type="button" id="approveBtn" class="btn btn-primary" onclick="window.location.href='toVerify'">审核</button>
					</c:if>
				</shiro:hasPermission>
			</div>
		</div>
		<div class="row">
				...
				<div class="box box-primary">
					<div class="box-body" style="overflow:auto;">
						<div id="Divcloum1" class="col-xs-6">
							<ul id="outlineTree" class="ztree"></ul>
						</div>
						<div id="rMenu">
							<ul>
			...
			<div class="col-md-9 col-lg-10" style="padding-left:0px;">
				<div class="box box-primary" style="margin-bottom:0px;">
					<div id="content" class="box-body" style="max-height:890px;over-flow:none;"></div>
				</div>
			</div>
		</div>
	</section>
...
<script type="text/javascript" src="<%=base%>/views/manage/ad/rulesRegulation/js/view.js"></script>
</body>
</html>