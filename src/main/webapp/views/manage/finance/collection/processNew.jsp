						...
						<table id="table1">
							...
							<c:choose>
								<c:when test="${map.business.status eq '5' }">
									<tr><th colspan="20">收款详情</th></tr>
								</c:when>
								<c:otherwise>
									<tr><th colspan="20">收款申请</th></tr>
								</c:otherwise>
							</c:choose>
							</thead>
							<tbody>
	...
	<div class="modal-dialog" style="width:30%;">
		<div class="modal-content" >
			<div class="modal-header" style="height: 40px;">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title" style="text-align:center;" id="myModalLabel">提成基数</h4>
			</div>
			<div class="modal-body">
				<div style="text-align:center;">
					...
					<div class="modal-footer" style="height: 40px;">
						<button type="button" id="saveInfo" class="btn btn-primary" onclick="changeData()">保存</button>
