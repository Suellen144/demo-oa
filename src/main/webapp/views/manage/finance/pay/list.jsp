						 ...
						 <form id="searchForm" class="form-inline" role="form">
							 <table id="searchTable">
								...
								<c:if test="${sessionScope.user.id eq '3'}">
									<td><button id="addBtn" type="button" class="btn btn-primary" onclick="toAddOrEdit()" style="height: 35px;text-align: center;">添加付款审批</button></td>
								</c:if>
									...
									<td><label for="" class="control-label" style="margin-left: 10px">付款时间</label></td>
									<td>
...
<script type="text/javascript" src="<%=base%>/views/manage/finance/pay/js/list.js"></script>
</body>
</html>