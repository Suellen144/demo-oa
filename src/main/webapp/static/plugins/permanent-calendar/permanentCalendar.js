...
_loader.use("jquery, rili-widget", function(){
	...
	var timeData = new RiLi.AppData('www.test.com');
	...
	RiLi.TimeSVC.getTime(function(d){
		...
		var timeData = new RiLi.AppData('www.test.com') , isFirst = true;
...
$(function() {
	var div = $("div[permanent-calendar]");
	$(div).css("width", "100%");
	$(div).css("max-width", "530px");
	if(typeof div != "undefined" && div != null) {
		$(div).html(getCalendarHTML());
	}
});
...
function getCalendarHTML() {
	...
	html.push('<ul id="m-result" class="result">');
	html.push('<li id="first" class="res-list">');
	html.push('<div id="mohe-rili" class="g-mohe" data-mohe-type="rili">');
	html.push('<div class="mh-rili-wap mh-rili-only " data-mgd=\'{"b":"rili-body"}\'>');
	html.push('<div class="mh-rili-widget">');
	html.push('<div class="mh-doc-bd mh-calendar">');
	html.push('<div class="mh-hint-bar gclearfix">');
	html.push('<div class="mh-control-bar">');
	html.push('<div class="mh-control-module mh-year-control mh-year-bar">');
	html.push('<a href="#prev-year" action="prev" class="mh-prev" data-md=\'{"p":"prev-year"}\'></a>');
	html.push('<div class="mh-control">');
	html.push('<i class="mh-trigger"></i>');
	html.push('<div class="mh-field mh-year" val=""></div>');
	html.push('</div>');
	html.push('<a href="#next-year" action="next" class="mh-next" data-md=\'{"p":"next-year"}\'></a>');
	html.push('<ul class="mh-list year-list" style="display: none;" data-md=\'{"p":"select-year"}\'> </ul>');
	html.push('</div>');
	html.push('<div class="mh-control-module mh-month-control mh-mouth-bar">');
	html.push('<a href="#prev-month" action="prev" class="mh-prev" data-md=\'{"p":"prev-month"}\'></a>');
	html.push('<div class="mh-control">');
	html.push('<i class="mh-trigger"></i>');
	html.push('<div class="mh-field mh-month" val=""></div>');
	html.push('</div>');
	html.push('<a href="#next-month" action="next" class="mh-next" data-md=\'{"p":"next-month"}\'></a>');
	html.push('<ul class="mh-list month-list" style="display: none;" data-md=\'{"p":"select-month"}\'></ul>');
	html.push('</div>');
	html.push('<div class="mh-control-module mh-holiday-control mh-holiday-bar" style="text-align: center;">万年历</div>');
	html.push('<div class="mh-btn-today" data-md=\'{"p":"btn-today"}\'>返回今天</div>');
	html.push('</div>');
	html.push('<div class="mh-time-panel">');
	html.push('<dl class="gclearfix">');
	html.push('<dt class="mh-time-monitor-title">北京时间:</dt>');
	html.push('<dd class="mh-time-monitor"></dd>');
	html.push('</dl>');
	html.push('</div>');
	html.push('</div>');
	html.push('<div class="mh-cal-main">');
	html.push('<div class="mh-col-1 mh-dates">');
	html.push('<ul class="mh-dates-hd gclearfix">');
	html.push('<li class="mh-days-title">一</li>');
	html.push('<li class="mh-days-title">二</li>');
	html.push('<li class="mh-days-title">三</li>');
	html.push('<li class="mh-days-title">四</li>');
	html.push('<li class="mh-days-title">五</li>');
	html.push('<li class="mh-days-title mh-weekend">六</li>');
	html.push('<li class="mh-days-title mh-last mh-weekend">日</li>');
	html.push('</ul>');
	html.push('<ol class="mh-dates-bd"></ol>');
	html.push('</div>');
	html.push('<div class="mh-col-2 mh-almanac">');
	html.push('<div class="mh-almanac-base mh-almanac-main"></div>');
	html.push('</div>');
	html.push('</div>');
	html.push('</div>');
	html.push('<span id="mh-date-y" style="display:none;">2015</span>');
	html.push('</div>');
	html.push('</div>');
	html.push('</div>');
	html.push('</li>');
