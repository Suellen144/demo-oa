 ...
 */
@Controller
@RequestMapping(value = "/manage/sys/workflow/model")
public class SysModelController extends BaseController {
    ...
    public ModelAndView toLlist() {
    	ModelAndView mav = new ModelAndView("manage/sys/workflow/model/list");
    ...
    public String deploy(@PathVariable("modelId") String modelId, RedirectAttributes redirectAttributes) {
    	CrudResultDTO result = new CrudResultDTO(CrudResultDTO.SUCCESS, "部署成功！");
        try {
            ...
            result = new CrudResultDTO(CrudResultDTO.EXCEPTION, "部署失败：" + e.getMessage());
        }
    ...
    public String delete(@PathVariable("modelId") String modelId) {
    	...
    	try {
    		...
    		result = new CrudResultDTO(CrudResultDTO.EXCEPTION, "删除失败：" + e.getMessage());
    	}
        return JSON.toJSONString(result);
    }
